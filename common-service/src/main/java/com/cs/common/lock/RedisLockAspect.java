...
import com.rys.invoice.common.lock.annotation.RedisLock;
import com.rys.invoice.common.lock.annotation.RedisLockParam;
import com.rys.invoice.common.lock.annotation.RedisLockRequest;
...
public class RedisLockAspect {
    ...
    @Around(value = "@annotation(com.rys.invoice.common.lock.annotation.RedisLock)")
    ...
    private String getLockedKey(ProceedingJoinPoint jp, Method method) throws Throwable {
         ...
         * 获取 RedisLockParam 对应参数的值
         */
        getRedisLockParam(jp, method, key);
    ...
    private void getRedisLockParam(ProceedingJoinPoint jp, Method method, StringBuilder key) {
    ...
    private String parse(Object root, String exp) {
        try {
            ...
            Expression expression = parser.parseExpression("#{" + exp + "}", ParserContext.TEMPLATE_EXPRESSION); //NOSONAR 设计如此
