...
public class Seal {
    ...
    public static void OfficialSeal_1() throws Exception {
        Seal.builder()
                .size(200)
                .borderCircle(Seal.SealCircle.builder().line(4).width(95).height(95).build())
                .mainFont(Seal.SealFont.builder().text("中国四大天王股份有限公司").family("隶书").size(22).space(22.0).margin(4).build())
                .centerFont(Seal.SealFont.builder().text("★").size(60).build())
                .titleFont(Seal.SealFont.builder().text("电子签章").size(16).space(8.0).margin(54).build())
                .build()
    ...
    public static void OfficialSeal_2() throws Exception {
        Seal.builder()
                .size(300)
                .borderCircle(Seal.SealCircle.builder().line(5).width(140).height(140).build())
                .mainFont(Seal.SealFont.builder().text("中国四大天王股份有限公司").size(35).space(35.0).margin(10).build())
                .centerFont(Seal.SealFont.builder().text("★").size(100).build())
                .titleFont(Seal.SealFont.builder().text("电子签章").size(22).space(10.0).margin(68).build())
                .build()
                .draw("/Users/chensong/Desktop/tmp/公章2.png");
    }

    public static void OfficialSeal_3() throws Exception {
        Seal.builder()
                .size(210)
                .borderCircle(Seal.SealCircle.builder().line(4).width(144).height(100).build())
                .borderInnerCircle(Seal.SealCircle.builder().line(1).width(140).height(96).build())
                .mainFont(Seal.SealFont.builder().text("河南省工匠城市规划建筑设计有限公司").size(22).space(10.0).margin(10).bold(false).build())
                .centerFont(SealFont.builder().text("91410526MA44PTEW4Y").size(20).space(8.0).margin(40).bold(false).build())
                .titleFont(Seal.SealFont.builder().text("发票专用章").size(30).space(12.0).margin(64).bold(false).build())
                .build()
                .draw("/Users/chensong/Desktop/tmp/公章3.png");
    }
    ...
    public static void PrivateSeal_1() throws Exception {
        Seal.builder()
                .size(300)
                .borderSquare(16)
                .mainFont(Seal.SealFont.builder().text("刘德").size(120).build())
                .build()
    ...
    public static void PrivateSeal_2() throws Exception {
        Seal.builder()
                .size(300)
                .borderSquare(16)
                .mainFont(Seal.SealFont.builder().text("刘德华印").size(120).build())
                .build()
    ...
    public boolean draw(String pngPath) throws Exception {
        ...
        //1.画布
        BufferedImage bi = new BufferedImage(size + 90, size, BufferedImage.TYPE_4BYTE_ABGR);
